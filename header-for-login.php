...
<body>
  <header id="header"><!--header-->
    <?php include ('thanks-login-header.php');?>
</header><!--/header-->
...
<section id="cart_items">
  <div class="container">
    ...
    <div class="step-one">
      <h2 class="heading">You are Login in Famous Home Furniture.</h2>
    </div>
    ...
    <div class="register-req">
      <p>Feelfree to purchase Every Thing for User Or Buyer Side.</p>
    </div><!--/register-req-->
