...
<head>
  ...
  <title>Password Change Thanks| FamousHomeFurniture</title>
  ...
  <div class="container">
    <div class="breadcrumbs">
      <ol class="breadcrumb">
        ...
        <li class="active">Thanks Password is Changed</li>
      </ol>
    </div><!--/breadcrums-->


    <div class="step-one">
      <h2 class="heading">Your Account Password is Changed Famous Home Furniture.</h2>
    </div>
    <div class="checkout-options">
      <h3>Thanks Password Changed</h3>
      <p>Welcome to Famous Home Furniture</p>
    </div><!--/checkout-options-->

    <div class="register-req">
      <p>Feelfree to login and purchase Every Thing for User Or Buyer Side.</p>
    </div><!--/register-req-->
